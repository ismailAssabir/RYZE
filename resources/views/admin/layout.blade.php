@extends('layouts.app')
@section('content')
<section class="mx-auto grid max-w-7xl gap-6 px-4 py-8 lg:grid-cols-[240px_1fr]">
    <aside class="rounded-xl bg-cyan-600 p-5 text-white shadow-xl dark:bg-cyan-900">
        <div class="mb-8 flex items-center gap-4 text-2xl font-black tracking-tight">
            <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-white text-cyan-600 shadow-sm dark:bg-zinc-900 dark:text-cyan-400">⚡</span>
            RYZE Admin
        </div>
